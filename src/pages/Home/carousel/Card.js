...
const Card = (props) => {
    return (
     ...
     <div className="card card--big">
       ...
       <img src={`https://image.tmdb.org/t/p/w500${props.infor.poster_path}`} alt="poster" style={props.imgStyle} />
       ...
       <div className={`${props.contentChange} card__content`}>
         <h3 className= "card__title">
           <NavLink to={`/detail/${props.infor.id}`} >{props.infor.title.length > 23 ? props.infor.title.substring(0, 22) + "..." : props.infor.title}</NavLink>
         </h3>
         <span className="card__category">
           <NavLink to={`/detail/${props.infor.id}`} >{props.infor.release_date}</NavLink>
