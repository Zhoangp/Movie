...
const Index = (props) => {
  ...
  const signUpSchema = yup.object().shape({
    taiKhoan: yup.string().required('* Field is not required!'),
                  ...
                  <Form action="#" className="sign__form">
                    ...
                    <div className="sign__group">
                      <Field
                        ...
                        name="hoTen"
                      />
                       <ErrorMessage render={msg => <div style={{color: "red", fontSize: 13, padding: "5px 0 0 10px"}}>{msg}</div>}  name="hoTen"></ErrorMessage>
                    </div>
                    <div className="sign__group">
                      <Field
                        onChange={formikProps.handleChange}
